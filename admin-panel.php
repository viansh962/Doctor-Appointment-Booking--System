...
if(isset($_GET["generate_"])){
  ...
  ob_end_clean();
  $obj_pdf -> Output("Prescription.pdf",'I');
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> MY DOC </a>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <!-- <a href="admin-panel.php?ID=" 
                              ...
                              <input type = "submit" onclick="alert('Download  Successfully');" name ="generate_bill" class = "btn btn-success" value="Prescription"/>
                              </a>
                              </td>
                              </form>
